            ...
            proxyResponse.on('data', data => rawData.push(data)).on('end', () => {
                ...
                proxify.url = url => {
                 ...
                 proxify.html = body => {
                    ...
                    if (req.path.includes("_aHR0cHM6Ly9hcHAubWF0aGFjYWRlbXkudXM")) {
                        const logoimg = document.querySelector("img");
                        if (logoimg) {
                            if(logoimg.src.includes("math-academy-400")){
                                document.querySelector("img").src = "https://MACSS.eliskol.repl.co/assets/MA-custom-logo.png";
                            }
                        ...
                        link.href = 'https://images.squarespace-cdn.com/content/v1/597b6fc4b8a79bbb5b3ac2de/1504631061240-MZP71XWEETPUXBA1J1X6/ke17ZwdGBToddI8pDm48kGfiFqkITS6axXxhYYUCnlRZw-zPPgdn4jUwVcJE1ZvWQUxwkmyExglNqGp0IvTJZUJFbgE-7XRK3dMEBRBhUpxQ1ibo-zdhORxWnJtmNCajDe36aQmu-4Z4SFOss0oowgxUaachD66r8Ra2gwuBSqM/favicon.ico?format=100w';
