const http = require('http'),
    ...
    app = (req, res) => {
        ...
        if (req.url == "/swag/_aHR0cHM6Ly9tYXRoYWNhZGVteS5jb20=_/css/app.css") {

            res.writeHead(200, { 'Content-Type': 'text/css' });

            fs.readFile(path.join(__dirname, "/custom-css/app.css"), function (err, data) {
                if (err) {
        ...
        else if (req.url == "/swag/_aHR0cHM6Ly9tYXRoYWNhZGVteS5jb20=_/css/question-answer.css") {

            res.writeHead(200, { 'Content-Type': 'text/css' });

            fs.readFile(path.join(__dirname, "/custom-css/question-answer.css"), function (err, data) {
                if (err) {
                    res.writeHead(404, 'Not Found');
                    res.write('404: File Not Found!');
                    return res.end();
        ...
        else if (req.url == "/swag/_aHR0cHM6Ly9tYXRoYWNhZGVteS5jb20=_/css/student-lesson.css") {

            res.writeHead(200, { 'Content-Type': 'text/css' });

            fs.readFile(path.join(__dirname, "/custom-css/student-lesson.css"), function (err, data) {
                if (err) {
                    res.writeHead(404, 'Not Found');
                    res.write('404: File Not Found!');
                    return res.end();
        ...
        if (req.url == "/swag/_aHR0cHM6Ly9tYXRoYWNhZGVteS5jb20=_/js/student-lesson.js") {

            res.writeHead(200, { 'Content-Type': 'text/javascript' });

            fs.readFile(path.join(__dirname, "/custom-js/student-lesson.js"), function (err, data) {
                if (err) {
                    res.writeHead(404, 'Not Found');
                    res.write('404: File Not Found!');
                    return res.end();
